export const i18nData = {
  "zh-CN": {
    translation: {
      ...
      "Merge Tag": "合并标签",
      "Target Tag": "目标标签",
      "Please select a target tag": "请选择目标标签",
      "No target tag found": "未找到目标标签",
      "Cannot merge a tag into itself": "不能将标签合并到自身",
      "Merge this tag into another tag. Existing resources will be moved and this tag will be deleted permanently.":
        "将当前标签合并到另一个标签。现有资源引用会迁移，当前标签会被永久删除。",
      "Tag merged successfully": "标签合并成功",
      "Edit Tag": "编辑标签",
  ...
  "zh-TW": {
    translation: {
      ...
      "Merge Tag": "合併標籤",
      "Target Tag": "目標標籤",
      "Please select a target tag": "請選擇目標標籤",
      "No target tag found": "未找到目標標籤",
      "Cannot merge a tag into itself": "不能將標籤合併到自身",
      "Merge this tag into another tag. Existing resources will be moved and this tag will be deleted permanently.":
        "將當前標籤合併到另一個標籤。現有資源引用會遷移，當前標籤會被永久刪除。",
      "Tag merged successfully": "標籤合併成功",
      "Edit Tag": "編輯標籤",
